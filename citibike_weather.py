...
spark.sql("SELECT Temp, Spd, Prcp, mean_duration, num_trips, YEAR(day_y) FROM bike_weather").show(5)

## Returns
+------------------+------------------+------------------+------------------+---------+-------------------------+
|              Temp|               Spd|              Prcp|     mean_duration|num_trips|year(CAST(day_y AS DATE))|
+------------------+------------------+------------------+------------------+---------+-------------------------+
| 22.83421052631578|4.9921052631578915|              58.8| 978.5992792792791|    16650|                     2013|
|23.210344827586205| 5.799999999999998|               1.6| 958.1295669377887|    22745|                     2013|
|23.536363636363635| 4.724242424242422|27.099999999999998| 974.3284851811197|    21864|                     2013|
|24.679310344827588| 4.282758620689656|               6.3|1273.1084385917763|    22326|                     2013|
|25.992000000000004|             4.804|               0.0| 1082.426609284864|    21842|                     2013|
+------------------+------------------+------------------+------------------+---------+-------------------------+

bike_weather_byyear = spark.sql("SELECT Temp, Spd, Prcp, mean_duration, num_trips, YEAR(day_y) FROM bike_weather")
bike_weather_byyear.createOrReplaceTempView("bike_weather_byyear")
